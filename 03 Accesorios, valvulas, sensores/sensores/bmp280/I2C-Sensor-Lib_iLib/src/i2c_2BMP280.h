#ifndef i2c_2bmp280_h
#define i2c_2bmp280_h
...
Driver for the 2BMP280-Sensor Second sensor in (0x77);
...
class 2BMP280 : public i2cSensor, public manualSensor
{
...
public:
    ...
    2BMP280(void) :  dig_T1(0), dig_P1(0), dig_T2(0), dig_T3(0), dig_P2(0), dig_P3(0), dig_P4(0), dig_P5(0), dig_P6(0), dig_P7(0), dig_P8(0), dig_P9(0), tFine(0)
    {
    };
